 ...
 *                                      type: string
 */
routes.post('/login', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                user = req.body;
                return [4 /*yield*/, (0, service_1.authenticateUser)(user)];
            case 1:
                token = _a.sent();
                if (!token)
                    throw new NotFoundError_1.NotFoundError('', 404, 'Pendente definir tratamento de exceções');
                res.send({
                    auth: true,
                    accessToken: token
                });
 ...
 *                              type: boolean
 */
routes.post('/verifyToken', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token;
    return __generator(this, function (_a) {
        try {
            token = req.body.token;
            res.send((0, service_1.isValidJwt)(token));
        }
        catch (error) {
            next(error);
        }
